...
function Footer() {
  return (
      ...
      <section className="relative overflow-hidden bg-white text-black py-8 hidden sm:block">
        <div className="container relative z-10 mx-auto px-4">
          <div className="-m-8 flex flex-wrap items-center justify-between">
            <Logo />
            <div className="w-auto p-8  block">
              <ul className="-m-5 flex flex-wrap items-center">
                <li className="p-5">
                  <Link className="font-medium text-black hover:text-orange-400" to="#">
                    Privacy Policy
                  </Link>
                </li>
                <li className="p-5">
            ...
            <div className="w-auto p-8">
              <div className="-m-1.5 flex flex-wrap">
                <div className="w-auto p-1.5">
                  <Link to="#">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-black hover:border-orange-400">
                      <svg
                        width="8"
                        height="14"
                        viewBox="0 0 8 14"
